				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form class="form-horizontal" action="AddProgramme" 
								enctype="multipart/form-data" method="post">
								<fieldset>
									<div class="form-group">
										<label class="col-sm-2 control-label" for="textinput" required>Programme Name</label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="textinput" required>No of Terms</label>
										<div class="col-sm-6">
											<input type="text" placeholder="No of Terms" name="noOfTerms"
												class="form-control" required>
										</div>
									</div>
							</div>
